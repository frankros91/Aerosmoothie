    ...
    async compileTrackLyrics(trackData) {
        ...
        for (let data in trackData) {
            ...
            if (firstResult){
                ...
                const noBadWordsArray = noStopWordsArray.filter( ( el ) => !badWords.includes( el ) );
                noBadWordsArray.forEach(lyric => {
